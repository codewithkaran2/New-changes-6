...
const leaderboardContainer = document.getElementById("leaderboardContainer");  // For displaying leaderboard
const viewLeaderboardButton = document.getElementById("viewLeaderboardButton");  // View leaderboard button
...
// View leaderboard button click handler  
viewLeaderboardButton.addEventListener("click", function() {  
  leaderboardContainer.style.display = "block";  
  viewLeaderboardButton.style.display = "none";  // Hide the button once clicked  
});  
